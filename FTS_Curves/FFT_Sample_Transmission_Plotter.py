...
def save_FFT_data(frequency_vector, transmission_vector, save_path):
    '''
    Inputs:
...
def run():
    ...
    for dict_ in [dict_12icm]:
        ...
        save_FFT_data(frequency_vector, divided_transmission_vector, save_path)
        fig = plot_FFT_data(frequency_vector, divided_transmission_vector, color=color, label=label)
