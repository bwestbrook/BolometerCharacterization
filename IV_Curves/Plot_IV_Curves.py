...
def convert_IV_to_real_units(bias_voltage, squid_voltage, squid_conv=30.0, v_bias_multiplier=1e-4,
...
def determine_squid_transimpedance(v_bias_real, corrected_squid_voltage, calibration_resistor_val):
    '''
...
def fit_and_remove_offset(x_vector, y_vector, n=1, clip=None, quick_plot=False, return_fit=False):
    '''
...
def plot_iv_curve(bolo_voltage_bias, bolo_current, clip=None):
    '''
