...
ftscurve_settings_popup_settings.ftscurve_popup_build_dict = {
                                                              ...
                                                              '_ftscurve_settings_popup_steps_per_point_label': {'text': 'Steps/Point:', 'position': (14, 0, 1, 1)},
                                                              ...
                                                              '_ftscurve_settings_popup_plot_interferogram_label': {'text': 'Plot Interferogram?', 'position': (19, 0, 1, 1)},
                                                              '_ftscurve_settings_popup_add_loacl_fft_label': {'text': 'Plot Local FFT?', 'position': (20, 0, 1, 1)},
                                                              }
