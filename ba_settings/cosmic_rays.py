...
# HARDWARE SETUP 
                                                             ...
                                                             '_cosmic_rays_popup_daq_channel_x_header_label': {'text': 'DAQ Channel X:', 'position': (2, 0, 1, 1)},
                                                             '_cosmic_rays_popup_daq_channel_x_combobox': { 'position': (2, 1, 1, 1)},

                                                             '_cosmic_rays_popup_daq_channel_y_header_label': {'text': 'DAQ Channel Y:', 'position': (2, 2, 1, 1)},
                                                             '_cosmic_rays_popup_daq_channel_y_combobox': { 'position': (2, 3, 1, 1)},

                                                             '_cosmic_rays_popup_squid_header_label': {'text': 'SQUID:', 'position': (3, 0, 1, 1), 'font': 'huge', 'color': 'red'},
                                                             '_cosmic_rays_popup_squid_select_combobox': {'function': '_update_squid_calibration', 'font': 'huge', 'color': 'red',
                                                                                                           'position': (3, 1, 1, 1)},

                                                             '_cosmic_rays_popup_squid_conversion_header_label': {'text': 'SQUID Calibration:', 'position': (3, 2, 1, 1)},
                                                             '_cosmic_rays_popup_squid_conversion_label': {'position': (3, 3, 1, 1)},

                                                             '_cosmic_rays_popup_voltage_factor_header_label': {'text': 'Voltage Factor:', 'position': (4, 0, 1, 1)},
                                                             '_cosmic_rays_popup_voltage_factor_combobox': {'position': (4, 1, 1, 1)},

                                                             '_cosmic_rays_popup_grt_range_header_label': {'text': 'GRT Range:', 'position': (4, 2, 1, 1)},
                                                             '_cosmic_rays_popup_grt_range_combobox': {'position': (4, 3, 1, 1)},

                                                             '_cosmic_rays_popup_daq_integration_time_header_label': {'text': 'Integration Time (ms) [min 40ms]:', 'position': (5, 0, 1, 1)},
                                                             '_cosmic_rays_popup_daq_integration_time_combobox': {'position': (5, 1, 1, 1)},

                                                             '_cosmic_rays_popup_daq_sample_rate_header_label': {'text': 'Sample Rate (Hz):', 'position': (5, 2, 1, 1)},
                                                             '_cosmic_rays_popup_daq_sample_rate_combobox': {'position': (5, 3, 1, 1)},
# PLOT SETUP 
                                                             ...
                                                             '_cosmic_rays_popup_sample_name_header_label': {'text': 'Sample Name:', 'position': (7, 0, 1, 1)},
                                                             '_cosmic_rays_popup_sample_name_lineedit': {'text': '', 'position': (7, 1, 1, 1)},
...
# VISUAL DATA MONITORING
                                                             ...
                                                             '_cosmic_rays_popup_xdata_label': {'alignment': 'Center', 'position': (1, 4, 5, 6)},

                                                             '_cosmic_rays_popup_xdata_mean_header_label': {'text': 'AVG:', 'alignment': 'Right', 'position': (6, 4, 1, 1)},
                                                             '_cosmic_rays_popup_xdata_mean_label': {'alignment': 'Left', 'position': (6, 5, 1, 1)},

                                                             '_cosmic_rays_popup_xdata_std_header_label': {'text': 'STD', 'alignment': 'Right', 'position': (6, 6, 1, 1)},
                                                             '_cosmic_rays_popup_xdata_std_label': {'alignment': 'Left', 'position': (6, 7, 1, 1)},

                                                             '_cosmic_rays_popup_ydata_label': {'alignment': 'Center', 'position': (7, 4, 5, 6)},

                                                             '_cosmic_rays_popup_ydata_mean_header_label': {'text': 'AVG:', 'alignment': 'Right', 'position': (12, 4, 1, 1)},
                                                             '_cosmic_rays_popup_ydata_mean_label': {'alignment': 'Left', 'position': (12, 5, 1, 1)},

                                                             '_cosmic_rays_popup_ydata_std_header_label': {'text': 'STD', 'alignment': 'Right', 'position': (12, 6, 1, 1)},
                                                             '_cosmic_rays_popup_ydata_std_label': {'alignment': 'Left', 'position': (12, 7, 1, 1)},

                                                             '_cosmic_rays_popup_xydata_label': {'alignment': 'Center', 'position': (13, 4, 5, 6)},
...
cosmic_rays_settings.cosmic_rays_combobox_entry_dict = {
                                                          '_cosmic_rays_popup_mode_combobox': ['IV', 'RT', 'Discrete'],
                                                          '_cosmic_rays_popup_daq_channel_x_combobox': ['0', '1', '2', '3', '4', '5', '6', '7'],
                                                          '_cosmic_rays_popup_daq_channel_y_combobox': ['0', '1', '2', '3', '4', '5', '6', '7'],
                                                          '_cosmic_rays_popup_squid_select_combobox': ['', '1', '2', '3', '4', '5', '6'],
                                                          '_cosmic_rays_popup_voltage_factor_combobox': ['1e-5', '1e-4'],
                                                          '_cosmic_rays_popup_daq_sample_rate_combobox': ['50', '500', '1000'],
                                                          '_cosmic_rays_popup_daq_integration_time_combobox': ['50', '100', '500', '1000'],
