...
ivcurve_settings_popup_settings.ivcurve_popup_build_dict = {
                                                            ...
                                                            '_ivcurve_settings_popup_sample_name_label': {'text': 'Sample Name',
                                                                                                          'position': (7, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_plot_label_label': {'text': 'Plot Label',
                                                                                                         'position': (8, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_optical_load_label': {'text': 'Optical Load (K)',
                                                                                                         'position': (9, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_v_fit_low_label': {'text': 'V Fit Lo (uV)',
                                                                                                         'position': (10, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_v_fit_high_label': {'text': 'V Fit Hi (uV)',
                                                                                                          'position': (11, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_v_plot_low_label': {'text': 'V Plot Lo (uV)',
                                                                                                         'position': (12, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_v_plot_high_label': {'text': 'V Plot Hi (uV)',
                                                                                                          'position': (13, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_fracrn_label': {'text': 'Frac Rn', 'position': (14, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_color_label': {'text': 'Color', 'position': (15, 0, 1, 1)},
                                                            ...
                                                            '_ivcurve_settings_popup_calibrate_squid_label': {'text': 'Calibrate SQUID?',
                                                                                                              'position': (17, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_band_label': {'text': 'Band Center (GHz)', 'position': (18, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_band_edge_low_label': {'text': 'Band Edge Low (GHz)', 'position': (19, 0, 1, 1)},
                                                            '_ivcurve_settings_popup_band_edge_high_label': {'text': 'Band Edge High (GHz)', 'position': (20, 0, 1, 1)},
