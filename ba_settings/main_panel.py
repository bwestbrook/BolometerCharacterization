...
main_panel_settings.main_panel_build_dict = {
                                             ...
                                             '_main_panel_rtcurve_checkbox': {'text': 'RT_Curve', 'function': '_select_analysis_type',
                                                                              'position': (4, 1, 1, 1)},
                                             '_main_panel_ftscurve_checkbox': {'text': 'FTS_Curve', 'function': '_select_analysis_type',
                                                                               'position': (4, 2, 1, 1)},
                                             '_main_panel_ifcurve_checkbox': {'text': 'IF_Curve', 'function': '_select_analysis_type',
                                                                              'position': (4, 3, 1, 1)},
