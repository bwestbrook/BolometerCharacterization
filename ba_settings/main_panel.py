...
main_panel_settings.main_panel_build_dict = {
                                             ...
                                             '_main_panel_select_files_pushbutton': {'text': 'Select File(s)', 'function': '_select_files', 'position': (1, 0, 1, 7)},
                                             '_main_panel_clear_files_pushbutton': {'text': 'Clear Files', 'function': '_clear_files', 'position': (2, 0, 1, 7)},
                                             '_main_panel_selected_file_label': {'text': '', 'position': (3, 0, 1, 7)},
                                             ...
                                             '_main_panel_beammap_pushbutton': {'text': 'Beam Map', 'function': '_select_analysis_type', 'position': (4, 6, 1, 1)},
                                             '_main_panel_close_pushbutton': {'text': 'Close', 'function': '_close_main', 'position': (6, 0, 1, 7)}
                                             }
