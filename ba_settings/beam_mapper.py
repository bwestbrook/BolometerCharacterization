...
beam_mapper_settings.beam_mapper_combobox_entry_dict = {'_beam_mapper_popup_x_current_com_port_combobox': ['COM5'],
                                                        '_beam_mapper_popup_y_current_com_port_combobox': ['COM12'],
