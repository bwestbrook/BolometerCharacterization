...
# HARDWARE SETUP 
                                                             ...
                                                             '_xycollector_popup_squid_conversion_label': {'position': (3, 3, 1, 1)},

                                                             '_xycollector_popup_voltage_factor_header_label': {'text': 'Voltage Factor:', 'position': (4, 0, 1, 1)},
...
# CONTROL BUTTONS 
                                                             ...
                                                             '_xycollector_popup_start_pushbutton': {'text': 'Start', 'function': '_run_xycollector', 'position': (13, 0, 1, 2)},

                                                             '_xycollector_popup_pause_pushbutton': {'text': 'Stop', 'function': '_stop', 'position': (13, 2, 1, 2)},

                                                             '_xycollector_popup_save_pushbutton': {'text': 'Make and Save Plots and Data', 'function': '_save_plots_and_data', 'position': (14, 0, 1, 4)},

                                                             '_xycollector_popup_close_pushbutton': {'text': 'Close', 'function': '_close_xycollector', 'position': (15, 0, 1, 4)},
...
# VISUAL DATA MONITORING
                                                             ...
                                                             '_xycollector_popup_xdata_label': {'alignment': 'Center', 'position': (1, 4, 3, 6)},

                                                             '_xycollector_popup_xdata_mean_header_label': {'text': 'AVG:', 'alignment': 'Right', 'position': (4, 4, 1, 1)},
                                                             '_xycollector_popup_xdata_mean_label': {'alignment': 'Left', 'position': (4, 5, 1, 1)},

                                                             '_xycollector_popup_xdata_std_header_label': {'text': 'STD', 'alignment': 'Right', 'position': (4, 6, 1, 1)},
                                                             '_xycollector_popup_xdata_std_label': {'alignment': 'Left', 'position': (4, 7, 1, 1)},

                                                             '_xycollector_popup_ydata_label': {'alignment': 'Center', 'position': (5, 4, 3, 6)},

                                                             '_xycollector_popup_ydata_mean_header_label': {'text': 'AVG:', 'alignment': 'Right', 'position': (8, 4, 1, 1)},
                                                             '_xycollector_popup_ydata_mean_label': {'alignment': 'Left', 'position': (8, 5, 1, 1)},

                                                             '_xycollector_popup_ydata_std_header_label': {'text': 'STD', 'alignment': 'Right', 'position': (8, 6, 1, 1)},
                                                             '_xycollector_popup_ydata_std_label': {'alignment': 'Left', 'position': (8, 7, 1, 1)},

                                                             '_xycollector_popup_xydata_label': {'alignment': 'Center', 'position': (10, 4, 3, 6)},
