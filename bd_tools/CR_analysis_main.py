...
class CosmicRayAnalyzer():
    ...
    def __init__(self):
        '''
        '''
        self.V2uA_SQ1 = 25.2 #define SQUID calibrations in uA/V
        self.V2uA_SQ2 = 25.2
        self.V2uA_SQ3 = 30.0
        self.V2uA_SQ4 = 30.0
        self.V2uA_SQ5 = 25.9
...
###########################################################################
    ...
    def cra_analyze(self,data, sets, SQs, gain, bias, scantime, noisefilt = False, verbose=True, detrend=True, inv = False, pwrcnv = False, fit = True):
        '''
        # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
