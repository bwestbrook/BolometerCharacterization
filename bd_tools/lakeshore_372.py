...
class LS372TempControl(QRunnable):
    ...
    def set_run_function(self, function_name, new_value=None):
        '''
        '''
        ...
        if new_value is None:
            ...
            self.run_function = lambda: function(new_value)
